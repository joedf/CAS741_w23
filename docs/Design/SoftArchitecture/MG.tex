...
\item [\refstepcounter{mnum} \mthemnum \label{M_GT}:] Ground Truth Image Input
...
\item [\refstepcounter{mnum} \mthemnum \label{M_imgInfo}:] Image Information and Metrics Display
\item [\refstepcounter{mnum} \mthemnum \label{M_metric}:] Image Metrics Calculation
\item [\refstepcounter{mnum} \mthemnum \label{M_stage}:] Drawing Stage / Canvas Module
