...
\begin{description}
  ...
  \item[\refstepcounter{acnum} \actheacnum \label{AC_inConst}:] The constraints on the input parameters.
  \item[\refstepcounter{acnum} \actheacnum \label{AC_outFormat}:] The format of the final output data.
  \item[\refstepcounter{acnum} \actheacnum \label{AC_outConst}:] The constraints on the output results.
  ...
  \item[\refstepcounter{acnum} \actheacnum \label{AC_maskOpts}:] The implementation for the ``Bit BLT'',
    compositing, or blending operations.
...
\acref{AC_inConst} & \mref{mVerify}\\
\acref{AC_outFormat} & \mref{mOutput}\\
\acref{AC_outConst} & \mref{mVerifyOut}\\
