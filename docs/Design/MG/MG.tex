...
jQuery DOM manipulation javascript library \cite{jquery}.
...
\begin{description}
\item[Secrets:]\an{The format and structure of the input data.} DOM Manipulation
\item[Services:]\an{Converts the input data into the data structure used by the
  input parameters module.}
\item[Implemented By:] WebBrowser and jQuery
