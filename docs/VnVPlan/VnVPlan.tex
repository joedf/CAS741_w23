...
\subsection{Tests for Functional and Nonfunctional Requirements}
...
satisfy both \rref{R_imageMetric} and \nfrref{NFR_Accuracy}, and thus will be described
...
performs in terms of accuracy given our suite of test images.
