...
\an{Prof says: The unit tests are decided by your module interfaces.}

\an{TODO: add unit tests for black, white and half black+white images tests for control.
and the various tests for og, fant, 10, 60, 120, etc. py and js tests.}

\an{Mention sewar python package and the js libraries for comparison.}
