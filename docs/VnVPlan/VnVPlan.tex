...
\item{\textbf{U\refstepcounter{unittestnum}\theunittestnum \label{U_metric1}}: control - ground truth vs. ground truth}
...
\item{\textbf{U\refstepcounter{unittestnum}\theunittestnum \label{U_metric1}}: control - ground truth vs. minor defects}
...
\begin{enumerate}
  ...
  \item The \code{fant} ground truth image is there for
\end{enumerate}
...
test image (as listed in \ttref{Tbl_TestImages}) using the different metrics
