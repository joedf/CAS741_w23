...
\item{control - all black vs. all white}
...
\item{control - all black vs. half black and white}
...
\item{control - all white vs. half black and white}
...
\item{control - all black vs. all gray}
...
\item{control - all white vs. all gray}
...
\item{control - all gray vs. half black and white}
...
The \href{https://pypi.org/project/sewar}{sewar} python package 
and following javascript libraries are used for ``oracle'' comparisons
to \progname{}'s NRMSE:
\begin{itemize}
  \item \href{https://github.com/obartra/ssim}{ssim.web-3.5.0.js}
  \item \href{https://github.com/darosh/image-mse-js}{image-mse.js}
  \item \href{https://github.com/darosh/image-ssim-js}{image-ssim.js}
  \item \href{https://github.com/darosh/image-ms-ssim-js}{image-ms-ssim.js}
\end{itemize}
...
\an{Prof says You should look to standard usability questionaires for inspiration.
...
\an{Prof says You should look to find (via google) standard checklists.}
