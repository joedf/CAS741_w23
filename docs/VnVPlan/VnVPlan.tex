...
\begin{enumerate}
  ...
  Input/Condition: A group of intended users, the SRS document \citep{SRS}, and 
...
\begin{enumerate}
  ...
  warnings (on the default strictness setting), and zero errors.
...
\begin{enumerate}
  ...
  Output/Result: The software runs on the platform of choice with little to no setup.
