...
\begin{enumerate}
  ...
  \item{\textbf{T\refstepcounter{testnum}\thetestnum}: Test import for PNG/JPG/BMP format}
  ...
  \item{\textbf{T\refstepcounter{testnum}\thetestnum}: Test PNG Image Export}
...
\begin{enumerate}
  ...
  \item{\textbf{T\refstepcounter{testnum}\thetestnum}: Spot Width and Height}
  ...
  \item{\textbf{T\refstepcounter{testnum}\thetestnum}: Spot Rotation}
    ...
    \item{\textbf{T\refstepcounter{testnum}\thetestnum}: Raster Grid / Pixel Size}
...
\begin{enumerate}
  ...
  \item{\textbf{T\refstepcounter{testnum}\thetestnum}: Higher metric value}
  ...
  \item{\textbf{T\refstepcounter{testnum}\thetestnum}: Low metric value}
